...
const Header: FC = memo(() => {
    const [currentSection, setCurrentSection] = useState<SectionId | null>(SectionId.Hero);
...
const NavItem: FC<{
    ...
    return (
        <Link activeClass="active" className={section} smooth={true} spy={true} to={section}>
