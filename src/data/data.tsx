...
export const aboutData: About = {
  ...
  description:
    "I'm a permanent student, reader, and learner. Software engineering is my passion and I find it most satisfying to help interpret creative ideas into useful software tools.\n" +
    '\n' +
...
export const skills: SkillGroup[] = [
  {
    ...
    skills: [
      {
        name: 'React (using Redux, Next.js and Material UI)',
        level: 8,
      },
      {
...
export const experience: TimelineItem[] = [
  {
    ...
    content: (
      <p>
        Working on various projects, using Rust, TypeScript, React.js, Java, Terraform, Cytoscape.js, Spring MVC + JSP,
        PostgreSQL, iBATIS, Amazon Web Services.
      </p>
    ),
  },
  {
    ...
    content: <p>Developing a web application by using React.js, JavaScript / TypeScript, Next.js, HTML and GraphQL.</p>,
  },
  {
